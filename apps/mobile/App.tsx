					...
					<View style={styles.body}>
						<View style={styles.sectionContainer}>
							...
							<Text style={styles.sectionDescription}>
								Edit <Text style={styles.highlight}>apps/mobile/App.tsx</Text> to change this screen and
						...
						<View style={styles.sectionContainer}>
							...
							<Text style={styles.sectionDescription}>
								<ReloadInstructions /> Alternatively, press <Text style={styles.highlight}>R</Text> in
								the bundler terminal window.
							</Text>
						</View>
						<View style={styles.sectionContainer}>
