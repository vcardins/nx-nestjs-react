...
export const StyledSelect = styled(Field)`
	&:not([size]) {
		...
		&:hover {
			border-color: ${({ theme }) => theme.colors.tertiary.lighterGrey };
		}

		&:focus {
			border-color: ${({ theme }) => theme.colors.tertiary.darkGrey };
			box-shadow: 0 0 1px 3px rgba(59, 153, 252, 0.7);
			box-shadow: 0 0 0 3px -moz-mac-focusing;
			background-color: ${({ theme }) => theme.colors.tertiary.grey };
			outline: none;
		}
